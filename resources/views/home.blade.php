...
{{-- ==== HERO / CAROUSEL (sin bordes, fondo cover) ==== --}}
@if($propertyImages->count() > 0)
    <style>
        ...
        .hero-section .carousel-item{
            /* La imagen del slide como background */
        ...
        /* Controles centrados y sin foco */
        ...
        /* Quitar bordes azules / focus en todo el carrusel */
        #heroCarousel:focus,
        #heroCarousel *:focus,
        ...
        /* Responsive: evitar solapes en tablet/móvil */
